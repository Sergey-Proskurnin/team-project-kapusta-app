...
import cocktailSvg from './icons/cocktail.svg';
...
import stripSvg from './icons/strip.svg';
...
const Report = () => {
  ...
  const iconTeg = `<use xlink:href="icon.svg#additional"></use>`;
  return (
    <>
      <div className={`${s.navigation} ${s.container}`}>
        <div>
      ...
      <div className={`${s.reportWrapper} ${s.container}`}>
        <div className={s.transactionWrapper}>
          <ArrowBackIosIcon style={{ color: '#FF751D' }} fontSize="small" />
          <h1>Расходы:</h1>
